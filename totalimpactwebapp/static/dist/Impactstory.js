...
angular.module("infopages/faq.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("infopages/faq.tpl.html",
    ...
    "\n" +
    "\n" +
    "   <h3 id=\"what-do-i-get\" class=\"first\">what do I get for the $5 a month?</h3>\n" +
    "\n" +
    ...
    "\n" +
    "\n" +
    "   <h3 id=\"why-charge\" class=\"first\">Impactstory is a non-profit. Why are you charging for profiles?</h3>\n" +
    "\n" +
    ...
    "\n" +
    "\n" +
    "   <h3 id=\"can-i-keep-data\" class=\"first\">do I get to keep my data if I unsubscribe?</h3>\n" +
    "\n" +
    ...
    "\n" +
    "\n" +
    "   <h3 id=\"waiver\" class=\"first\">what if I can&rsquo;t afford $5 a month?</h3>\n" +
    "\n" +
    "   <p>We offer fee waivers, no questions asked. To learn more, email us at team@impactstory.org.</p>\n" +
    "\n" +
    "\n" +
    "   <h3 id=\"fee-but-open\" class=\"first\">how can profiles still be Open if they cost money?</h3>\n" +
    "\n" +
