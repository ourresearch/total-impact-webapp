/*! ImpactStory - v0.0.1-SNAPSHOT - 2013-12-19
...
angular.module("profile",["resources.users","product.product","directives.jQueryPopover","services.page","update.update","ui.bootstrap","security","services.loading","tips","profile.addProducts","product.categoryHeading","services.i18nNotifications"]).config(["$routeProvider",function(e,t){e.when("/embed/:url_slug",{templateUrl:"profile/profile.tpl.html",controller:"ProfileCtrl"})}]).factory("UserProfile",function(e,t,n,r,i,s,o){var u={};return{makeAnchorLink:function(e,t){var r=e;t&&(r+=":"+encodeURIComponent(t));return n.path()+"#"+r},filterProducts:function(e,t){var n=_.filter(e,function(e){return _.size(e.metrics)}),r=_.filter(e,function(e){return e.metrics&&_.size(e.metrics)==0});return t=="withMetrics"?n:t==="withoutMetrics"?r:n.concat(r)},scrollToCorrectLocation:function(){if(n.hash())t();else{var r=o.getLastScrollPosition(n.path());e.scrollTo(0,r)}},loadUser:function(e,t){return r.get({id:t,idType:"url_slug"},function(e){o.setTitle(e.about.given_name+" "+e.about.surname)},function(n){if(n.status==404){e.userExists=!1;e.slug=t}})},slugIsCurrentUser:function(e){return i.getCurrentUser()?i.getCurrentUser().url_slug==e:!1},makeSlug:function(){u.url_slug=s.make(u.givenName,u.surname)},readyToCreateOnServer:function(){return u.url_slug&&!id},reset:function(){u={}},setId:function(e){id=e},getId:function(){return id},getSlug:function(){return u.url_slug},about:u}}).controller("ProfileCtrl",function(e,t,n,r,i,s,o,u,a,f,l,c,h,p,d,v,m,g){g.isEmbedded();var y=a.get("$http");e.$on("ngRepeatFinished",function(e){twttr.widgets.load()});var b=r.url_slug,w=!0;e.loadingProducts=function(){return w};e.userExists=!0;e.showProductsWithoutMetrics=!1;e.filterProducts=h.filterProducts;e.user=h.loadUser(e,b);e.currentUserIsProfileOwner=function(){return h.slugIsCurrentUser(b)};e.openProfileEmbedModal=function(){i.open({templateUrl:"profile/profile-embed-modal.tpl.html",controller:"profileEmbedModalCtrl",resolve:{userSlug:function(e){return e.when(b)}}})};e.getSortScore=function(e){return c.getSortScore(e)*-1};e.getMetricSum=function(e){return c.getMetricSum(e)*-1};e.dedup=function(){m.start("dedup");l.dedup({id:b},{},function(e){console.log("deduped!",e);m.finish("dedup");d.removeAll();d.pushForCurrentRoute("dedup.success","success",{numDuplicates:e.deleted_tiids.length});E(!0)})};var E=function(t){w=!0;t&&y.removeAll();console.log("rendering profile products");e.products=l.query({id:b,includeHeadingProducts:!0,idType:"url_slug"},function(e){w=!1;s(function(){h.scrollToCorrectLocation()},0)},function(e){w=!1})};s(E,100)}).controller("profileEmbedModalCtrl",function(e,t,n){console.log("user slug is: ",n);e.userSlug=n;e.baseUrl=t.getBaseUrl()}).directive("backToProfile",function(e){return{restrict:"A",replace:!0,template:"<a ng-show='returnLink' class='back-to-profile' href='/{{ returnLink }}'><i class='icon-chevron-left'></i>back to profile</a>",link:function(t,n){var r=/^\/(\w+)\/product\/(\w+)/,i=r.exec(e.path());t.returnLink=null;if(i){var s=i[1];s!="embed"&&(t.returnLink=s)}}}});
